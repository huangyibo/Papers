...
#tf.app.flags.DEFINE_string("word_embedding_file", '/home/os/textmining/wiki.zh.vec', "extra word embeddings.")
tf.app.flags.DEFINE_string("word_embedding_file", '/devdata1/JunpengZhu/Papers/Knowledge-Graph/NER/wiki.zh.vec', "extra word embeddings.")
