 ...
 * -I/usr/local/include/json-c -I/home/os/json-c-json-c-0.13.1-20180305 (config.h is here) -L/usr/local/lib
 *  gcc -o a.out test4.c -I/usr/local/include/json-c -I/home/os/json-c-json-c-0.13.1-20180305 -L/usr/local/lib -ljson-c
 */
